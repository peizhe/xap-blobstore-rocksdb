...
//      db1 = RocksDB.open(options, db_path1);
...
//      }
      ...
      RocksIterator iterator1 = db.newIterator();
      iterator1.seekToFirst();
        while(iterator1.isValid()) {
            byte[] k = iterator1.key();
            for (int i = 0; i < k.length; i++) {
                System.out.print(k[i]);
            }
            System.out.println();
            byte[] d = iterator1.value();
            for (int i = 0; i < d.length; i++) {
                System.out.print(d[i]);
            }
            System.out.println("------------------------------------------------");
...
//      System.out.println("key = " + iterator1.key().toString().getBytes());
//      System.out.println("value = " + iterator1.value().toString().getBytes());
//      assert(iterator1.key() != null);
//      assert(iterator1.value() != null);
//
